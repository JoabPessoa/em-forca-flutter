...
class DatabaseHelper {
  ...
  Future<Database> _initDB(String filePath) async {
    ...
    return await openDatabase(
      path,
      version: 18, // <-- Nova versãobpara acionar a atualização
  ...
  Future<void> _popularBancoDados(Database db) async {
    final palavras = [
      ...
      {'texto': 'FREIA', 'dica': 'Deusa nordica do amor, da fertilidade e da magia', 'categoria': 'Mitologia', 'dificuldade': 'dificil'},
      ...
      // -- Video Games
      {'texto': 'EM FORCA', 'dica': 'O jogo mobile incrível focado em adivinhar palavras que você está jogando agora mesmo', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'SONIC', 'dica': 'O borrão azul supersônico', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'SUPER MARIO', 'dica': 'O encanador bigodudo do Reino dos Cogumelos', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'POKEMON', 'dica': 'Temos que pegar todos!', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'PAC MAN', 'dica': 'O comedor de pastilhas amarelo', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'MINECRAFT', 'dica': 'Jogo de sobrevivência e construção em um mundo infinito feito inteiramente de blocos', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'GRAND THEFT AUTO', 'dica': 'Franquia de mundo aberto focada em crime, roubos de carros e missões em cidades como Los Santos', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'THE SIMS', 'dica': 'Famoso simulador de vida humana onde você constrói casas e controla o cotidiano dos personagens', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'FIFA', 'dica': 'A mais famosa e tradicional franquia de simulação de futebol dos videogames', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'CALL OF DUTY', 'dica': 'Giga-franquia de tiro em primeira pessoa famosa por suas campanhas militares e modo multiplayer', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'COUNTER STRIKE', 'dica': 'Jogo de tiro tático competitivo focado no confronto entre terroristas e contra-terroristas', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'GOD OF WAR', 'dica': 'Franquia de ação que narra a jornada de vingança de Kratos contra os deuses de várias mitologias', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'FORTNITE', 'dica': 'Battle royale extremamente popular conhecido por suas construções rápidas e mecânica de passes de batalha', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'LEAGUE OF LEGENDS', 'dica': 'O MOBA mais jogado do mundo, onde duas equipes de cinco campeões duelam em Summoners Rift', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'MORTAL KOMBAT', 'dica': 'Franquia de luta icônica famosa por sua violência explícita e pelos movimentos de Fatalities', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'ANGRY BIRDS', 'dica': 'Jogo mobile de grande sucesso onde se usam estilingues para arremessar pássaros contra porcos verdes', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'CLASH OF CLANS', 'dica': 'Jogo de estratégia mobile focado em construir vilas, treinar tropas e atacar clãs rivais', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'CRAZY TAXI', 'dica': 'Corrida arcade onde o objetivo é entregar passageiros da forma mais insana possível', 'categoria': 'Jogos', 'dificuldade': 'facil'},
      {'texto': 'DONKEY KONG', 'dica': 'O rei gorila de gravata vermelha', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'CRASH BANDICOOT', 'dica': 'O marsupial giratório da ilha N. Sanity', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'MEGAMAN', 'dica': 'O bombardeiro azul da Capcom', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'SPYRO', 'dica': 'O pequeno dragão roxo cuspido de fogo', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'THE LEGEND OF ZELDA', 'dica': 'O herói do tempo de túnica verde', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'TOMB RAIDER', 'dica': 'A exploradora de tumbas mais famosa dos games', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'SUPER MONKEY BALL', 'dica': 'Incline o cenário para rolar símios dentro de esferas de vidro até a linha de chegada', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'STREETS OF RAGE', 'dica': 'Clássico de pancadaria onde heróis limpam as ruas do sindicato do Mr. X', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'GOLDEN AXE', 'dica': 'Pancadaria medieval clássica de fliperama com bárbaros, anões e magias devastadoras', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'RESIDENT EVIL', 'dica': 'Franquia pioneira do terror de sobrevivência focada em surtos de zumbis e armas biológicas', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'ASSASSINS CREED', 'dica': 'Série que mistura ficção e eventos históricos através de uma ordem secreta que usa parkour e furtividade', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'GUITAR HERO', 'dica': 'Franquia de ritmo que fez sucesso estrondoso ao simular a performance de músicas usando guitarras de plástico', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'STREET FIGHTER', 'dica': 'Franquia de luta japonesa que popularizou os comandos de Hadouken e Shoryuken nos fliperamas', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'HALO', 'dica': 'Série de ficção científica de tiro que acompanha o supersoldado Master Chief em guerras espaciais', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'VALORANT', 'dica': 'Jogo de tiro tático que mistura habilidades de personagens com balística precisa em equipes de cinco', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'OVERWATCH', 'dica': 'Jogo de tiro em equipe focado em heróis com habilidades únicas disputando objetivos em mapas globais', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'NEED FOR SPEED', 'dica': 'Franquia de corrida de rua famosa por customização pesada de carros e perseguições policiais', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'RATCHET AND CLANK', 'dica': 'Franquia de plataforma e tiro espacial protagonizada por uma criatura felina e seu pequeno parceiro robô', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'RED DEAD REDEMPTION', 'dica': 'Aclamada saga de mundo aberto ambientada no Velho Oeste durante o fim da era dos fora da lei', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'FINAL FANTASY', 'dica': 'Lendária antologia de RPG japonesa conhecida por suas histórias profundas, chocobos e invocações mágicas', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'THE WITCHER', 'dica': 'RPG baseado em livros que segue as aventuras do bruxo mutante Geralt de Rívia caçando monstros', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'SUBWAY SURFERS', 'dica': 'Popular jogo mobile de corrida infinita onde o personagem picha trens e foge de um inspetor', 'categoria': 'Jogos', 'dificuldade': 'medio'},
      {'texto': 'BAYONETTA', 'dica': 'A bruxa de Umbra que esbanja estilo lutando com armas equipadas em seus saltos altos', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'NIGHTS', 'dica': 'O ser mágico andrógino e acrobático que sobrevoa o mundo dos sonhos', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'JET SET RADIO', 'dica': 'Patinadores rebeldes fazendo manobras e espalhando grafites pelas ruas de Tokyo-to', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'YAKUZA', 'dica': 'A dramática e muitas vezes absurda saga do Dragão de Dojima no submundo japonês', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'SHENMUE', 'dica': 'A pioneira jornada de Ryo Hazuki em busca de vingança que revolucionou os mundos abertos', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'PHANTASY STAR', 'dica': 'Pioneiro RPG clássico de ficção científica ambientado no sistema estelar de Algol', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'DARK SOULS', 'dica': 'Franquia de RPG de ação conhecida por sua atmosfera sombria, lore enigmática e altíssimo nível de dificuldade', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'METAL GEAR', 'dica': 'Série pioneira no estilo de espionagem tática criada pelo diretor Hideo Kojima', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'THE LAST OF US', 'dica': 'Franquia cinematográfica focada na sobrevivência emocional em um mundo pós-apocalíptico infectado', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'UNCHARTED', 'dica': 'Série de ação focada em caça a tesouros perdidos vivida pelo carismático Nathan Drake', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'CYBERPUNK', 'dica': 'RPG futurista ambientado na megalópole Night City dominada por corporações e modificações cibernéticas', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'MONSTER HUNTER', 'dica': 'Franquia da Capcom focada em caçar criaturas gigantescas para forjar armas e armaduras com seus recursos', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'BORDERLANDS', 'dica': 'Série de tiro que mistura elementos de RPG e visual em desenho, famosa por bilhões de armas geradas aleatoriamente', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'DIABLO', 'dica': 'Franquia de RPG de ação no estilo isométrica focada em derrotar hordas de demônios e coletar saques raros', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'CASTLEVANIA', 'dica': 'Clássica série de ação gótica focada em caçadores de vampiros explorando o castelo do Conde Drácula', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'SILENT HILL', 'dica': 'Aclamada série de terror psicológico focada em uma cidade misteriosa coberta por névoa e pesadelos', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'DEVIL MAY CRY', 'dica': 'Franquia de ação estilosa focada em combates acrobáticos com espadas e armas do caçador de demônios Dante', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'PORTAL', 'dica': 'Genial jogo de quebra-cabeças focado em criar conexões espaciais para escapar dos testes de uma inteligência artificial sarcástica', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'DOOM', 'dica': 'Franquia histórica focada em combates frenéticos contra demônios ao som de trilhas pesadas de metal', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'SKYRIM', 'dica': 'Aclamado RPG de mundo aberto focado na lenda do guerreiro Dragonborn e no retorno dos dragões', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
      {'texto': 'FRIDAY NIGHT FUNKIN', 'dica': 'Jogo musical rítmico independente de código aberto que virou febre na internet com batalhas de rap no teclado', 'categoria': 'Jogos', 'dificuldade': 'dificil'},
