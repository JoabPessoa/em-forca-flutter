...
class DatabaseHelper {
  ...
  Future<void> _popularBancoDados(Database db) async {
    final palavras = [
      ...
      {'texto': 'CAÇADOR', 'dica': 'Homem que salva Chapeuzinho Vermelho e sua avo abrindo a barriga do lobo', 'categoria': 'Contos de Fada', 'dificuldade': 'facil'},
      ...
      {'texto': 'A PEQUENA VENDEDORA DE FÓSFOROS', 'dica': 'Conto triste sobre uma menina que se aquece com visoes ao acender palitos no frio', 'categoria': 'Contos de Fada', 'dificuldade': 'dificil'},
